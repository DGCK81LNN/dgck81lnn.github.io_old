...
try {
    ...
    if (!localStorage.soulTest) {
        ...
        var msg2 = {
            ...
            es2016: "您的浏览器不支持 ECMAScript 2016 ，网站功能将无法正常使用。如果可以，请您",
            es2017: "您的浏览器不支持 ECMAScript 2017 ，网站功能将无法正常使用。如果可以，请您",
            es2018: "您的浏览器不支持 ECMAScript 2018 ，部分功能将无法正常使用。如果可以，请您",
            es2019: "您的浏览器不支持 ECMAScript 2019 ，部分功能将无法正常使用。如果可以，建议您",
            es2020: "您的浏览器不支持 ECMAScript 2020 ，某些功能可能无法正常使用。如果可以，建议您",
        }[_test];
        /*
         * 弹框辣！
         */
